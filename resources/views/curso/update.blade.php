            ...
            <div class="col-6 mt-5 mb-5">
                ...
                <form action="{{ route('curso.update', $curso->id) }}" method="POST">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Nome do Curso" value="{{ $curso->name }}">
                    </div>

                    <div class="form-group mt-3">
                        <label for="description">Descrição do Curso</label>
                        <input type="text" name="description" id="description" class="form-control" placeholder="Descrição do Curso" value="{{ $curso->description }}">
                    </div>
